package com.android.loading.widget;
...
//    private View defineLoadingPage;
    ...
    private static int emptyImgId = R.mipmap.define_empty;
    private static int errorImgId = R.mipmap.define_error;//需要定义错误
    private static int networkImgId = R.mipmap.define_nonetwork;
